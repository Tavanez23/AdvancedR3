...
#' Create a tidy output of the model result
#'
...
#'
#' @param model_results, the dataframe with the model results
#' @param data original lipidomics file
#'
#' @return A data frame
